...
El proceso implica además ciertas manipulaciones para ofrecer capas homogéneas para el periodo 2001 a 2018.
...
- Las capas de lindes municipales incluyen los polígonos que no pertenecen a municipios, los llamados condominios, cuya codificación y nomenclatura ha cambiado considerablemente a lo largo del tiempo. Estos se han homogeneizado de acuerdo con la última práctica del IGN, y algunos de ellos se han editado para mantener la homogeneidad en el tiempo. No es seguro que esta codificación se mantenga en el tiempo, dado lo peculiar de estos territorios[^4].
...
Finalmente, tras estos procesos, se obtuvieron ficheros de contornos municipales, y un registro por recinto --municipio o condominio-- en la tabla de atributos. Los condominios son 84, y los municipios los existentes a fecha de 1 de enero de cada año.
...
Tal y como se indica abajo se ofrece un fichero de polígonos municipales por año, y para Provincias y Comunidades Autónomas (CCAA) solo uno, el correspondiente a la descarga más reciente[^5]. Si lo que se desea es disponer de una capa* de Provincias o CCAA que sea plenamente consistente con los municipios de un año concreto para hacer cálculos geográficos se recomienda que dicha layer sea obtenida por generalización del fichero de municipios correspondiente. La razón es que entre descargas se pueden haber producido alteraciones en los lindes de provincia, CCAA, frontera o de costa, por ejemplo, aunque solo sea por redefinición geométrica. De esta forma se asegura que la información de Provincias y Comunidades Autónomas es totalmente compatible con la de los ficheros de municipios de esa año.
...
[^1]: En concreto se efectuaron descargas en mayo de 2011, febrero de 2013 y junio de 2016. El formato original de descarga es _shape_ de ESRI, y el tratamiento de los ficheros se hizo en ArcGIS.
...
[^4]: Sobre los condominios véase el apéndice de Goerlich, Ruiz, Chorén y Albert (2015).

[^5]: Dichas capas se obtuvieron por generalización de la capar de contornos municipales, y no se tomaron directamente de la Base de Datos de Líneas de Límite del CNIG.
